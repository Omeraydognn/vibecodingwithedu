...
"Do you want to continue, or should I explain this further?
1. Anladım, devam et (Understood, continue)
2. Anlamadım, daha detaylı anlat (I didn't understand, explain more)
3. Diğer (Other - type your own question)"
```
...
### 1) Initialize the rules in your project
...
### 3) Install Interactive UI (MCP Server) - Optional but Recommended

For the best experience, VibeCoding includes an **MCP Server** that pops up a sleek, clickable OS dialog (like an alert box) when asking learning check questions, instead of just printing text in the chat.
This works across all MCP-supported environments (Cursor, Windsurf, Claude Code, Antigravity, etc.) globally without downloading anything manually!
